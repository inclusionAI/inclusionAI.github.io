...
<p align="left">
        <a href="https://github.com/inclusionAI/Ming/tree/Ming-Lite-Omni-Preview/Ming-unify" target="_blank" rel="noopener noreferrer" className="btn-link">GITHUB</a> 📑 <a href="https://arxiv.org/pdf/2505.02471">Paper</a>｜🤗 <a href="https://huggingface.co/inclusionAI/Ming-Lite-Uni">Hugging Face</a>｜🤖 <a href="https://modelscope.cn/models/inclusionAI/Ming-Lite-Uni">ModelScope</a>
</p>
...
Ming is licensed under the [MIT License](https://github.com/inclusionAI/Ming/blob/main/LICENSE), and the Legal Disclaimer is located in the [LEGAL.md file](https://github.com/inclusionAI/Ming/blob/main/LEGAL.md) under the project's root directory.
