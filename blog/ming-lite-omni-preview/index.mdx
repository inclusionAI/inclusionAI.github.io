...
| MultiModal Input                                                                                                                          | QA                                                                                                                                                                                                                        |
| ----------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <video src="https://github.com/user-attachments/assets/a1327779-030a-44d0-a073-bbc1abe04efc" controls width="70%" height="auto" ></video> | Q: `<audio>` (audio content: 请描述视频内容。)<br />A: The video features a woman performing a series of yoga poses on a rooftop with a scenic view of mountains and a clear blue sky. |
...
This code repository is licensed under the [MIT License](https://github.com/inclusionAI/Ming/blob/main/LICENSE), and the Legal Disclaimer is located in the [LEGAL.md file](https://github.com/inclusionAI/Ming/blob/main/LEGAL.md) under the project's root directory.
