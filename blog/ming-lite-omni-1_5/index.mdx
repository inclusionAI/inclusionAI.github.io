...
import segData from './cases/seg_en.json';
import chatData from './cases/chat_en.json';
...
<div style={{textAlign: "center", margin: "auto", width: "100%"}}>
  ...
  <p style={{fontSize: "14px", color: "gray"}}>Performance Comparison</p>
</div>
...
<div style={{textAlign: "center"}}>
  ...
  <p style={{fontSize: "14px", color: "gray"}}>Mode Architecture</p>
</div>
