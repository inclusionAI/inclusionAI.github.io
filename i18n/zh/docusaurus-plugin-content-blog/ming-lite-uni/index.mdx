...
<p align="left">
        <a href="https://github.com/inclusionAI/Ming/tree/Ming-Lite-Omni-Preview/Ming-unify" target="_blank" rel="noopener noreferrer" className="btn-link">GITHUB</a> 📑 <a href="https://arxiv.org/abs/2505.02471">Technical Report</a>｜🤗 <a href="https://huggingface.co/inclusionAI/Ming-Lite-Uni">Hugging Face</a>｜🤖 <a href="https://modelscope.cn/models/inclusionAI/Ming-Lite-Uni">ModelScope</a>
</p>
...
Ming 遵循 [MIT 许可证](https://github.com/inclusionAI/Ming/blob/main/LICENSE)，法律声明见项目根目录下的 [LEGAL.md 文件](https://github.com/inclusionAI/Ming/blob/main/LEGAL.md)。
