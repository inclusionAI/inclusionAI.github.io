...
import segData from '@site/blog/ming-lite-omni-1_5/cases/seg.json';
import chatData from '@site/blog/ming-lite-omni-1_5/cases/chat.json';

<a href="https://github.com/inclusionAI/Ming" target="_blank" rel="noopener noreferrer" className="btn-link">GITHUB</a> 🤗 <a href="https://huggingface.co/inclusionAI/Ming-Lite-Omni-1.5">Hugging Face</a>｜ 🤖 <a href="https://www.modelscope.cn/models/inclusionAI/Ming-Lite-Omni-1.5">ModelScope</a>
...
<div style={{textAlign: "center", margin: "auto", width: "100%"}}>
  ...
  <p style={{fontSize: "14px", color: "gray"}}>性能对比图</p>
</div>
...
<ExampleGallery examples={[segData]} scroll={true} />
**深度及边缘检测**
...
<ExampleGallery examples={[chatData]} scroll={true} />
# 模型架构升级与能力评测
...
<div style={{textAlign: "center"}}>
  ...
  <p style={{fontSize: "14px", color: "gray"}}>模型架构图</p>
</div>
