  ...
  return (
    ...
    >
      ...
      {/* <div className={styles.releasesSection}>
        <img
          className={styles.releasesTitle}
          src="https://mdn.alipayobjects.com/huamei_ljitfi/afts/img/A*WDENRLHlbGYAAAAAQFAAAAgAekZ_AQ/original"
          alt="Releases"
        />
        <div className={styles.articleGrid}>
          {RELEASE_ARTICLES.map((article) => (
            <Link
              key={article.cover}
              to={article.link ?? "/blog"}
            ...
            >
              ...
              <div className={styles.articleTime}>{article.time}</div>
            </Link>
          ))}
        </div>
      </div> */}
